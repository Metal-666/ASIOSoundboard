...
class SettingsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) => ConstrainedBox(
      constraints: const BoxConstraints.expand(), child: _scrollView());
  ...
  Widget _scrollView() => SingleChildScrollView(
        ...
        children:
          ...
          'Board': _boardSettings()
                ...
                .entries
                .map<Widget>((MapEntry<String, Widget> entry) =>
                    _settingsCard(entry.key, entry.value))
                .toList(),
      ));

  /// Builds a basic card for a settings category. Makes [header] the title of the card and puts [content] underneath.
  Widget _settingsCard(String header, Widget content) => Padding(
